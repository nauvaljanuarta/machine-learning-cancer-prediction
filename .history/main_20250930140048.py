...
# ===============================
# 5b. Uji ANOVA (format tabel terminal)
# ===============================
print("\n=== ANOVA Test (Fitur vs Target: Biopsy) ===")

for col in selected_features:
    group_stats = df_minmax_lib.groupby("Biopsy")[col].agg(['count','mean','std'])
    ...
    if p < 0.05:
        ...
        print("Tidak terdapat perbedaan signifikan antara kelompok (p >= 0.05).")
